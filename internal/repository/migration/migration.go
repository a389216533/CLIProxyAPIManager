...
const (
	...
	migrationAddProxyPools                          = "20260701_add_proxy_pools"
	migrationAddUsageIdentityWorkspaceName          = "20260702_add_usage_identity_workspace_name"
	migrationCreateAuthFileCooldowns                = "20260702_create_auth_file_cooldowns"
)
...
func orderedMigrations() []databaseMigration {
	return []databaseMigration{
		...
		{version: migrationAddProxyPools, run: addProxyPoolsMigration},
		{version: migrationAddUsageIdentityWorkspaceName, run: addUsageIdentityWorkspaceNameMigration},
		{version: migrationCreateAuthFileCooldowns, run: createAuthFileCooldownsMigration},
	}
}
