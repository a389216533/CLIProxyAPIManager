...
const DEFAULT_TIME_RANGE: KeyOverviewTimeRange = 'today';
      ...
      <div className={styles.pageFrame}>
        <header className={styles.topBar}>
          <div className={styles.brandBlock}>
            ...
            <span className={styles.liveLastRefreshed}>
              {t('usage_stats.last_updated')}: {lastRefreshedAt ? lastRefreshedAt.toLocaleTimeString() : '-'}
            </span>
          </div>
